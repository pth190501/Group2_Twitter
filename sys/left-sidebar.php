...
<ul class="nav flex-column sticky-top" style="height: 100vh;">
    <div class="col">
        ...
        <div class="list-group" id="list-tab" role="tablist">
            ...
            <div class="container-fluid col-7 font-weight-bold">
                <a class="list-group-item list-group-item-action list-group-item-light border-0 rounded-pill text-dark" id="list-home-list" data-bs-toggle="list" href="messages.php" role="tab">
